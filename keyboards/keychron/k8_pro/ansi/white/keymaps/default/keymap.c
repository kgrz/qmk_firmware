...
qk_tap_dance_action_t tap_dance_actions[] = {
    // Tap once for cmd, twice for cmd+shift
    [TD_RCMD_SHIFT_CMD] = ACTION_TAP_DANCE_DOUBLE(KC_RGUI, KC_ESC),
};
...
[MAC_BASE] = LAYOUT_ansi_87(
     ...
     KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC, DT_PRNT,    DT_DOWN,  DT_UP,
     KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS, AS_RPT,    AS_DOWN,   AS_UP,
     KC_LCTL,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
     SC_LSPO,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            SC_RSPC,            KC_UP,
     TT(MAC_FN),  KC_LOPTN, KC_LCMMD,    MT(MOD_RGUI|MOD_LSFT, KC_SPC),    TD(TD_RCMD_SHIFT_CMD), KC_ROPTN, TT(MAC_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[MAC_FN] = LAYOUT_ansi_87(
     ...
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  BAT_LVL,  NK_TOGG,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,            AS_UP,
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  AS_TOGG,  AS_DOWN,  AS_RPT),
